...
namespace ServerFTP.ClasseMetier
{
    ...
    public class ClientConnection : IDisposable
    {
        ...
        public ClientConnection(TcpClient client, Manager.ManagerConsole consoleManager)
        {
        ...
        public void HandleClient(object obj)
        {
                    ...
                    if (response == null)
                    {
                        switch (cmd)
                        {
                            ...
                            case "PASS":
                                ...
                                this.consoleManager.AppendText("pwd = ******", false); ;
                                break;
                            case "CWD":
                            ...
                            case "PORT":
                                ...
                                this.consoleManager.AppendText("Port " + _dataEndpoint.Port.ToString(), false);
                                break;
                            case "PASV":
                                response = Passive();
                            ...
                            case "TYPE":
                                ...
                                this.consoleManager.AppendText("URI " + command[1],false);
            ...
            {
                this.consoleManager.AppendText(ex.Message, true);
            }
        ...
        private string Delete(string pathname)
        {
            ...
            if (this._currentUser.delete)
            {
                if (pathname != null)
                {
                    ...
                    {
                        res = "550 File Not Found";
                    }

                    res = "250 File deleted";
                }
            }
            else
                res = "550 Vous n'avez pas les droits.";
        ...
        private string RemoveDir(string pathname)
        {
            ...
            string res = "";
            if (this._currentUser.directory)
            {
                pathname = NormalizeFilename(pathname);
        ...
        private string ListOperation(NetworkStream dataStream, string pathname)
        {
            ...
            this.consoleManager.AppendText("IP : "+_clientIP,false);
            this.consoleManager.AppendText("Method : "+ "LIST",false);
            this.consoleManager.AppendText("USER : "+_username,false);
            this.consoleManager.AppendText("Statut : "+"226",false);
